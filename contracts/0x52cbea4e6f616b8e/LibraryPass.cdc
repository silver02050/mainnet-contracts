            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: collectionName,
                        description: "Published NFT is pioneering eBooks in Web3, complete with a metaverse and big ideas on innovating what it means to collect and interact with written media.",
