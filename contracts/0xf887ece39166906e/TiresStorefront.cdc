...
pub contract TiresStorefront {
    ...
    init () {
        ...
        self.account.save(<-TiresStorefront.createStorefront() , to: self.StorefrontStoragePath) 
        self.account.link<&TiresStorefront.Storefront{TiresStorefront.StorefrontPublic}>(self.StorefrontPublicPath, target: self.StorefrontStoragePath)
