...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x6b8b76833ea500b2
    self.collectionStoragePath = /storage/StoreFrontCollection0x6b8b76833ea500b2
    self.collectionPrivatePath = /private/StoreFrontCollection0x6b8b76833ea500b2
