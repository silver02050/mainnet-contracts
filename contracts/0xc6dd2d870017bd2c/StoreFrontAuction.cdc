...
pub contract StoreFrontAuction {
    ...
    init() {
        ...
        self.collectionPublicPath = /public/StoreFrontAuctionCollection0xc6dd2d870017bd2c
        self.collectionStoragePath = /storage/StoreFrontAuctionCollection0xc6dd2d870017bd2c
    }
}
