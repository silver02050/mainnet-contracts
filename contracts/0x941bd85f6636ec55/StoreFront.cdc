...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x941bd85f6636ec55
    self.collectionStoragePath = /storage/StoreFrontCollection0x941bd85f6636ec55
    self.collectionPrivatePath = /private/StoreFrontCollection0x941bd85f6636ec55
