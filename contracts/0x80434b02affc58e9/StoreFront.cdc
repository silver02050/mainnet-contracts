...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x80434b02affc58e9
    self.collectionStoragePath = /storage/StoreFrontCollection0x80434b02affc58e9
    self.collectionPrivatePath = /private/StoreFrontCollection0x80434b02affc58e9
