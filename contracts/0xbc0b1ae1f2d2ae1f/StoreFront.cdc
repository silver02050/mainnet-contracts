...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xbc0b1ae1f2d2ae1f
    self.collectionStoragePath = /storage/StoreFrontCollection0xbc0b1ae1f2d2ae1f
    self.collectionPrivatePath = /private/StoreFrontCollection0xbc0b1ae1f2d2ae1f
