...
pub contract FridgeMagnetV1: NonFungibleToken {
    ...
    pub event SetUpdated(setID: UInt32, name: String)
    ...
    pub resource Set {
        ...
        pub fun updateMetadata(newMetadata: {String: AnyStruct}) {
            pre {
                newMetadata.length != 0 : "New Metadata cannot be empty!!!"
            }
    ...
    // Updated one
    pub struct FridgeMagnetV1CustomViewsUpdated {
        // All the var we want to view
        pub let name: String
        pub let description: String
        pub let image: String
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        pub fun getViews(): [Type] {
            return [
                ...
                Type<FridgeMagnetV1CustomViewsUpdated>()
            ]
        }
            ...
            switch view {
                ...
                case Type<MetadataViews.ExternalURL>():
                    ...
                    return MetadataViews.ExternalURL(
                        "https://www.fridgemagnet.xyz/nft/"
                    )
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: FridgeMagnetV1.CollectionStoragePath,
                        publicPath: FridgeMagnetV1.CollectionPublicPath,
                        providerPath: /private/CollectionPrivatePath,
                        publicCollection: Type<&Collection{NFTCollectionPublic}>(),
                        publicLinkedType: Type<&Collection{NFTCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Collection{NFTCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <- FridgeMagnetV1.createEmptyCollection()
                        })
                    )
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "FridgeMagnet",
                        description: "FridgeMagnet makes managing NFT campaigns easy and accessible for businesses.",
                        externalURL: MetadataViews.ExternalURL("https://www.fridgemagnet.xyz/nft"),
