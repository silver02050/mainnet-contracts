...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x61b32707be1e33d2
    self.collectionStoragePath = /storage/StoreFrontCollection0x61b32707be1e33d2
    self.collectionPrivatePath = /private/StoreFrontCollection0x61b32707be1e33d2
