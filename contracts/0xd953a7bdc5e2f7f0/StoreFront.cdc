...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xd953a7bdc5e2f7f0
    self.collectionStoragePath = /storage/StoreFrontCollection0xd953a7bdc5e2f7f0
    self.collectionPrivatePath = /private/StoreFrontCollection0xd953a7bdc5e2f7f0
