...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x3fcf12d7cac5907f
    self.collectionStoragePath = /storage/StoreFrontCollection0x3fcf12d7cac5907f
    self.collectionPrivatePath = /private/StoreFrontCollection0x3fcf12d7cac5907f
