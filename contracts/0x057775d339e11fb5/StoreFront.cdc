...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x057775d339e11fb5
    self.collectionStoragePath = /storage/StoreFrontCollection0x057775d339e11fb5
    self.collectionPrivatePath = /private/StoreFrontCollection0x057775d339e11fb5
