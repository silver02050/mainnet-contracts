...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xa333f6184300345d
    self.collectionStoragePath = /storage/StoreFrontCollection0xa333f6184300345d
    self.collectionPrivatePath = /private/StoreFrontCollection0xa333f6184300345d
