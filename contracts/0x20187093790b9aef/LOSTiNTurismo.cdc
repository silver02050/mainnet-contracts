...
pub contract LOSTiNTurismo: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            ...
            LOSTiNTurismo.totalSupply = LOSTiNTurismo.totalSupply + (1 as UInt64)
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    ...
                    if self.data.thumbnailHosting == "IPFS" {
                        thumbnail =  MetadataViews.IPFSFile(
                            cid: self.data.thumbnailCID, 
                            path: self.data.thumbnailPathIPFS
                        )
                    }
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: LOSTiNTurismo.CollectionStoragePath,
                        publicPath: LOSTiNTurismo.CollectionPublicPath,
                        providerPath: /private/LOSTiNTurismoCollection,
                        publicCollection: Type<&LOSTiNTurismo.Collection{LOSTiNTurismo.LOSTiNTurismoCollectionPublic}>(),
                        publicLinkedType: Type<&LOSTiNTurismo.Collection{LOSTiNTurismoCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&LOSTiNTurismo.Collection{LOSTiNTurismoCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-LOSTiNTurismo.createEmptyCollection()
                        })
                    )
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "LOSTiNTurismo",
                        description: LOSTiNTurismo.Description,
                        externalURL: LOSTiNTurismo.ExternalURL,
                        squareImage: LOSTiNTurismo.SquareImage,
                        bannerImage: LOSTiNTurismo.BannerImage,
                        socials: LOSTiNTurismo.Socials
                    )
    ...
    pub resource Mutator {
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String){
           ...
           pre{
                tokenID <= LOSTiNTurismo.totalSupply: "the tokenID does not exist"
           }
    ...
    pub resource Admin {
        ...
        pub fun setSquareImage(url: String, mediaType: String) {
            LOSTiNTurismo.SquareImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun setBannerImage(url: String, mediaType: String) {
            LOSTiNTurismo.BannerImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            pre {
                LOSTiNTurismo.defaultRoyalties[name] == nil: "The royalty with that name already exists"
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64) {
            pre {
                LOSTiNTurismo.defaultRoyalties[name] != nil: "The royalty with that name does not exist"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
            ...
            LOSTiNTurismo.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "LOSTiNTurismo Royalties")
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){
            ...
            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "LOSTiNTurismo Royalties")
    ...
    pub resource interface LOSTiNTurismoCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowLOSTiNTurismo(id: UInt64): &LOSTiNTurismo.NFT? {
    ...
    //
    pub resource Collection: LOSTiNTurismoCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            return LOSTiNTurismoNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub fun createEmptyMintPFPsCollection(): @LOSTiNTurismo.Collection {
        return <-create LOSTiNTurismo.Collection()
    }
    ...
    init() {
        ...
        self.SquareImage = MetadataViews.Media(
            file: MetadataViews.HTTPFile(
                url: "https://mint-store-metadata.s3.us-east-2.amazonaws.com/lostin/utility-thumbnails/logo_square(2).png"
            ),
            mediaType: "image/png"
        )
        ...
        self.BannerImage = MetadataViews.Media(
            file: MetadataViews.HTTPFile(
                url: "https://mint-store-metadata.s3.us-east-2.amazonaws.com/lostin/utility-thumbnails/Vuurtoreneiland_Annelore-01.png"
            ),
            mediaType: "image/png"
        )
        ...
        self.account.link<&{LOSTiNTurismoCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
