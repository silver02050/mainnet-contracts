...
pub contract Lufthaus: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            ...
            Lufthaus.totalSupply = Lufthaus.totalSupply + (1 as UInt64)
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: Lufthaus.CollectionStoragePath,
                        publicPath: Lufthaus.CollectionPublicPath,
                        providerPath: /private/LufthausCollection,
                        publicCollection: Type<&Lufthaus.Collection{Lufthaus.LufthausCollectionPublic}>(),
                        publicLinkedType: Type<&Lufthaus.Collection{LufthausCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&Lufthaus.Collection{LufthausCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-Lufthaus.createEmptyCollection()
                        })
                    )
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "Lufthaus",
                        description: Lufthaus.Description,
                        externalURL: Lufthaus.ExternalURL,
                        squareImage: Lufthaus.SquareImage,
                        bannerImage: Lufthaus.BannerImage,
                        socials: Lufthaus.Socials
                    )
    ...
    pub resource Mutator {
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String){
           ...
           pre{
                tokenID <= Lufthaus.totalSupply: "the tokenID does not exist"
           }
    ...
    pub resource Admin {
        ...
        pub fun setSquareImage(url: String, mediaType: String) {
            Lufthaus.SquareImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun setBannerImage(url: String, mediaType: String) {
            Lufthaus.BannerImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            pre {
                Lufthaus.defaultRoyalties[name] == nil: "The royalty with that name already exists"
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64) {
            pre {
                Lufthaus.defaultRoyalties[name] != nil: "The royalty with that name does not exist"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
            ...
            Lufthaus.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "Lufthaus Royalties")
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){
            ...
            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "Lufthaus Royalties")
    ...
    pub resource interface LufthausCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowLufthaus(id: UInt64): &Lufthaus.NFT? {
    ...
    //
    pub resource Collection: LufthausCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
    ...
    pub fun createEmptyMintPFPsCollection(): @Lufthaus.Collection {
        return <-create Lufthaus.Collection()
    }
    ...
    init() {
        ...
        self.SquareImage = MetadataViews.Media(
            file: MetadataViews.HTTPFile(
                url: "https://mint-store-metadata.s3.us-east-2.amazonaws.com/lufthaus/Laufthause+1+x+1.png"
            ),
            mediaType: "image/png"
        )
        ...
        self.BannerImage = MetadataViews.Media(
            file: MetadataViews.HTTPFile(
                url: "https://mint-store-metadata.s3.us-east-2.amazonaws.com/lufthaus/Laufthause+2+x+1.png"
            ),
            mediaType: "image/png"
        )
        ...
        self.account.link<&{LufthausCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
