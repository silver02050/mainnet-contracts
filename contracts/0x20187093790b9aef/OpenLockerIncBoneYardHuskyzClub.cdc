...
pub contract OpenLockerIncBoneYardHuskyzClub: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
        ...
        init(name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String) {
            ...
            OpenLockerIncBoneYardHuskyzClub.totalSupply = OpenLockerIncBoneYardHuskyzClub.totalSupply + (1 as UInt64)
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return  MetadataViews.NFTCollectionData(
                        storagePath: OpenLockerIncBoneYardHuskyzClub.CollectionStoragePath,
                        publicPath: OpenLockerIncBoneYardHuskyzClub.CollectionPublicPath,
                        providerPath: /private/OpenLockerIncBoneYardHuskyzClubCollection,
                        publicCollection: Type<&OpenLockerIncBoneYardHuskyzClub.Collection{OpenLockerIncBoneYardHuskyzClub.OpenLockerIncBoneYardHuskyzClubCollectionPublic}>(),
                        publicLinkedType: Type<&OpenLockerIncBoneYardHuskyzClub.Collection{OpenLockerIncBoneYardHuskyzClubCollectionPublic, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&OpenLockerIncBoneYardHuskyzClub.Collection{OpenLockerIncBoneYardHuskyzClubCollectionPublic,NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-OpenLockerIncBoneYardHuskyzClub.createEmptyCollection()
                        })
                    )
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        ...
                        description: OpenLockerIncBoneYardHuskyzClub.Description,
                        externalURL: OpenLockerIncBoneYardHuskyzClub.ExternalURL,
                        squareImage: OpenLockerIncBoneYardHuskyzClub.SquareImage,
                        bannerImage: OpenLockerIncBoneYardHuskyzClub.BannerImage,
                        socials: OpenLockerIncBoneYardHuskyzClub.Socials
                    )
    ...
    pub resource Mutator {
        ...
        pub fun mutatePFP(tokenID: UInt64, name: String, description: String, thumbnail: String, thumbnailCID: String, thumbnailPathIPFS: String?, thumbnailMimeType: String, thumbnailHosting: String, mediaURL: String, mediaCID: String, mediaPathIPFS: String?, mimetype: String, mediaHosting: String, attributes: {String: String}, rarity: String){
           ...
           pre{
                tokenID <= OpenLockerIncBoneYardHuskyzClub.totalSupply: "the tokenID does not exist"
           }
    ...
    pub resource Admin {
        ...
        pub fun setSquareImage(url: String, mediaType: String) {
            OpenLockerIncBoneYardHuskyzClub.SquareImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun setBannerImage(url: String, mediaType: String) {
            OpenLockerIncBoneYardHuskyzClub.BannerImage = MetadataViews.Media(
                file: MetadataViews.HTTPFile(
                    url: url
                ),
                mediaType: mediaType
        ...
        pub fun addDefaultRoyalty(name: String, royalty: MetadataViews.Royalty, rate: UFix64){
            ...
            pre {
                OpenLockerIncBoneYardHuskyzClub.defaultRoyalties[name] == nil: "The royalty with that name already exists"
        ...
        pub fun changeDefaultRoyaltyRate(name: String, rate: UFix64) {
            pre {
                OpenLockerIncBoneYardHuskyzClub.defaultRoyalties[name] != nil: "The royalty with that name does not exist"
                rate > 0.0: "Cannot set rate to less than 0%"
                rate <= 1.0: "Cannot set rate to more than 100%"
            }
            ...
            OpenLockerIncBoneYardHuskyzClub.defaultRoyalties[name] = MetadataViews.Royalty(recipientAddress: previousRecipientAddress, cut: UFix64(rate), description: "OpenLockerIncBoneYardHuskyzClub Royalties")
        ...
        pub fun changeRoyaltyRateForPFP(tokenID: UInt64, name: String, rate: UFix64){
            ...
            let newRoyalty = MetadataViews.Royalty(recipientAddress: previousRoyalty.receiver, cut: UFix64(rate), description: "OpenLockerIncBoneYardHuskyzClub Royalties")
    ...
    pub resource interface OpenLockerIncBoneYardHuskyzClubCollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun batchDeposit(tokens: @NonFungibleToken.Collection)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowOpenLockerIncBoneYardHuskyzClub(id: UInt64): &OpenLockerIncBoneYardHuskyzClub.NFT? {
    ...
    //
    pub resource Collection: OpenLockerIncBoneYardHuskyzClubCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection { 
        ...
        pub fun borrowViewResolver(id: UInt64): &AnyResource{MetadataViews.Resolver} {
            ...
            return OpenLockerIncBoneYardHuskyzClubNFT as &AnyResource{MetadataViews.Resolver}
        }
    ...
    pub fun createEmptyMintPFPsCollection(): @OpenLockerIncBoneYardHuskyzClub.Collection {
        return <-create OpenLockerIncBoneYardHuskyzClub.Collection()
    }
    ...
    init() {
        ...
        self.account.link<&{OpenLockerIncBoneYardHuskyzClubCollectionPublic}>(self.CollectionPublicPath, target: self.CollectionStoragePath)
