...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xd1b0d1ae259a9dfa
    self.collectionStoragePath = /storage/StoreFrontCollection0xd1b0d1ae259a9dfa
    self.collectionPrivatePath = /private/StoreFrontCollection0xd1b0d1ae259a9dfa
