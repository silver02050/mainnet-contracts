...
pub contract StoreFrontAuction {
    ...
    init() {
        ...
        self.collectionPublicPath = /public/StoreFrontAuctionCollection0x9ffa085e9b92f847
        self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x9ffa085e9b92f847
    }
}
