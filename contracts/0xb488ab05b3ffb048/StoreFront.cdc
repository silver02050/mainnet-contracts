...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xb488ab05b3ffb048
    self.collectionStoragePath = /storage/StoreFrontCollection0xb488ab05b3ffb048
    self.collectionPrivatePath = /private/StoreFrontCollection0xb488ab05b3ffb048
