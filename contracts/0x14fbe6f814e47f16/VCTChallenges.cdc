...
pub contract VCTChallenges: NonFungibleToken {
            ...
            switch view {
                ...
                case Type<MetadataViews.Editions>():
                    let editionInfo: MetadataViews.Edition = MetadataViews.Edition(
                        name: "Challenge #".concat(self.metadata["ChallengeNumber"]!),
                        number: UInt64(self.sequence + 1),
                        max: UInt64(self.limit)
                    )
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: VCTChallenges.CollectionStoragePath,
                        publicPath: VCTChallenges.CollectionPublicPath,
                        providerPath: /private/VCTChallengesCollection,
                        publicCollection: Type<&VCTChallenges.Collection{VCTChallenges.VCTChallengesCollectionPublic}>(),
                        publicLinkedType: Type<&VCTChallenges.Collection{VCTChallenges.VCTChallengesCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&VCTChallenges.Collection{VCTChallenges.VCTChallengesCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-VCTChallenges.createEmptyCollection()
                        })
                    )
    ...
    pub resource interface VCTChallengesCollectionPublic {
        ...
        pub fun borrowVCTChallenges(id: UInt64): &VCTChallenges.NFT? {
            post {
    ...
    pub resource Collection: VCTChallengesCollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
    ...
    pub fun createEmptyCollection(): @VCTChallenges.Collection {
    ...
    pub resource Modifier {
        ...
        pub fun setURLMetadata(currentNFT: &VCTChallenges.NFT?, newURL: String, newThumbnail: String) : String {
            let ref2 =  currentNFT!
        ...
        pub fun setRarity(currentNFT: &VCTChallenges.NFT?, rarity:UFix64, rarityName:String, rarityValue:String)  {
            let ref2 =  currentNFT!
            ref2.setRarityHelper(rarity: rarity, rarityName: rarityName, rarityValue: rarityValue)
            log("Rarity metadata is updated")
        }
        
        pub fun setEdition(currentNFT: &VCTChallenges.NFT?, editionNumber:UInt64)  {
            let ref2 =  currentNFT!
            ref2.setEditionHelper(editionNumber: editionNumber)
            log("Edition metadata is updated")
        }
        
        pub fun setMetadata(currentNFT: &VCTChallenges.NFT?, metadata_name: String, metadata_value: String)  {
            let ref2 =  currentNFT!
	...
	init() {
        ...
        self.account.link<&{VCTChallenges.VCTChallengesCollectionPublic, NonFungibleToken.CollectionPublic, NonFungibleToken.Receiver, MetadataViews.ResolverCollection}>(
            self.CollectionPublicPath, 
            target: self.CollectionStoragePath
        )
        self.account.save(<-create NFTMinter(), to: self.MinterStoragePath)
        self.account.save(<-create Modifier(), to: /storage/VCTChallengesModifier)
