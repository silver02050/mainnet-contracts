...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x46457f680657a8de
    self.collectionStoragePath = /storage/StoreFrontCollection0x46457f680657a8de
    self.collectionPrivatePath = /private/StoreFrontCollection0x46457f680657a8de
