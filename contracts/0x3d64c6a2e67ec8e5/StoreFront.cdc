...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x3d64c6a2e67ec8e5
    self.collectionStoragePath = /storage/StoreFrontCollection0x3d64c6a2e67ec8e5
    self.collectionPrivatePath = /private/StoreFrontCollection0x3d64c6a2e67ec8e5
