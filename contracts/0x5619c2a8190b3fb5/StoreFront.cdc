...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x5619c2a8190b3fb5
    self.collectionStoragePath = /storage/StoreFrontCollection0x5619c2a8190b3fb5
    self.collectionPrivatePath = /private/StoreFrontCollection0x5619c2a8190b3fb5
