...
pub contract betaLilaiNFT: NonFungibleToken, ViewResolver {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: betaLilaiNFT.CollectionStoragePath,
                        publicPath: betaLilaiNFT.CollectionPublicPath,
                        providerPath: /private/betaLilaiNFTCollection,
                        publicCollection: Type<&betaLilaiNFT.Collection{betaLilaiNFT.betaLilaiNFTCollectionPublic}>(),
                        publicLinkedType: Type<&betaLilaiNFT.Collection{betaLilaiNFT.betaLilaiNFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&betaLilaiNFT.Collection{betaLilaiNFT.betaLilaiNFTCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(
            ...
            thumbnail: String,
            royalties: [MetadataViews.Royalty],
            lilaiputiaData: String // Updated parameter name for Lilaiputia data
        ) {
            ...
            var newNFT <- create NFT(
                id: betaLilaiNFT.totalSupply,
                name: name,
                description: description,
                thumbnail: thumbnail,
                royalties: royalties,
                metadata: metadata,
                lilaiputia: lilaiputia // Assign the Lilaiputia data directly
            )
    ...
    init() {
        ...
        self.account.link<&betaLilaiNFT.Collection{NonFungibleToken.CollectionPublic, betaLilaiNFT.betaLilaiNFTCollectionPublic, MetadataViews.ResolverCollection}>(
