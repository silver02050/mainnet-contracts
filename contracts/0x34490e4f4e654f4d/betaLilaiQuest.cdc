pub contract betaLilaiQuest {
    ...
    init() {
        ...
        self.account.link<&betaLilaiQuest.NFTMinter{NFTMinterPublic}>(/public/betaLilaiQuestNFTMinter, target: /storage/LilaiQuestNFTMinter)
    }
}