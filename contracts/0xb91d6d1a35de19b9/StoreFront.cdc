...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xb91d6d1a35de19b9
    self.collectionStoragePath = /storage/StoreFrontCollection0xb91d6d1a35de19b9
    self.collectionPrivatePath = /private/StoreFrontCollection0xb91d6d1a35de19b9
