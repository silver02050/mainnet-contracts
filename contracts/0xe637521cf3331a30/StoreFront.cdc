...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xe637521cf3331a30
    self.collectionStoragePath = /storage/StoreFrontCollection0xe637521cf3331a30
    self.collectionPrivatePath = /private/StoreFrontCollection0xe637521cf3331a30
