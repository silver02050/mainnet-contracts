...
pub contract StoreFrontAuction {
    ...
    init() {
        ...
        self.collectionPublicPath = /public/StoreFrontAuctionCollection0x51dfd687bfd739ef
        self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x51dfd687bfd739ef
    }
}
