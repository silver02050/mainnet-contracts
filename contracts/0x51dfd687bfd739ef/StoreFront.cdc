...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x51dfd687bfd739ef
    self.collectionStoragePath = /storage/StoreFrontCollection0x51dfd687bfd739ef
    self.collectionPrivatePath = /private/StoreFrontCollection0x51dfd687bfd739ef
