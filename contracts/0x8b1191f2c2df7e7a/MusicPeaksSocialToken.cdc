...
pub contract MusicPeaksSocialToken: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: MusicPeaksSocialToken.FLOATCollectionStoragePath,
                        publicPath: MusicPeaksSocialToken.FLOATCollectionPublicPath,
                        providerPath: /private/MusicPeaksSocialTokenCollectionPrivatePath,
                        ...
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <- MusicPeaksSocialToken.createEmptyCollection()
                        })
                    )
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "MusicPeaksSocialToken",
                        description: "MusicPeaksSocialToken is a proof of attendance platform on the Flow blockchain.",
        ...
        init(_eventDescription: String, _eventHost: Address, _eventId: UInt64, _eventImage: String, _eventName: String, _originalRecipient: Address, _serial: UInt64) {
            ...
            self.eventsCap = getAccount(_eventHost)
                .getCapability<&FLOATEvents{FLOATEventsPublic, MetadataViews.ResolverCollection}>(MusicPeaksSocialToken.FLOATEventsPublicPath)
        ...
        destroy() {
            ...
            // of who owns the MusicPeaksSocialToken is going to be messed up. But that is their
            // fault. We shouldn't let that prevent the user from deleting the MusicPeaksSocialToken.
    ...
    pub resource FLOATEvent: FLOATEventPublic, MetadataViews.Resolver {
        ...
        pub fun getCurrentHolder(serial: UInt64): TokenIdentifier? {
            ...
            let collection = getAccount(data.address).getCapability(MusicPeaksSocialToken.FLOATCollectionPublicPath).borrow<&Collection{CollectionPublic}>()
    ...
    pub resource FLOATEvents: FLOATEventsPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowSharedRef(fromHost: Address): &FLOATEvents {
            ...
            let otherFLOATEvents = getAccount(fromHost).getCapability(MusicPeaksSocialToken.FLOATEventsPublicPath)
