...
pub contract StoreFrontAuction {
    ...
    init() {
        ...
        self.collectionPublicPath = /public/StoreFrontAuctionCollection0xf8f8e5db161c815d
        self.collectionStoragePath = /storage/StoreFrontAuctionCollection0xf8f8e5db161c815d
    }
}
