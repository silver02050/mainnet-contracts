...
pub contract StoreFrontSuperAdmin {
  ...
  init() {
    // Paths
    self.storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xf8f8e5db161c815d
    self.storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xf8f8e5db161c815d
