...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x8e55bf2f5aefeab3
    self.collectionStoragePath = /storage/StoreFrontCollection0x8e55bf2f5aefeab3
    self.collectionPrivatePath = /private/StoreFrontCollection0x8e55bf2f5aefeab3
