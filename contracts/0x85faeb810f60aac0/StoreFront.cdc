...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x85faeb810f60aac0
    self.collectionStoragePath = /storage/StoreFrontCollection0x85faeb810f60aac0
    self.collectionPrivatePath = /private/StoreFrontCollection0x85faeb810f60aac0
