...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xb7ff7d2e1d4e86a0
    self.collectionStoragePath = /storage/StoreFrontCollection0xb7ff7d2e1d4e86a0
    self.collectionPrivatePath = /private/StoreFrontCollection0xb7ff7d2e1d4e86a0
