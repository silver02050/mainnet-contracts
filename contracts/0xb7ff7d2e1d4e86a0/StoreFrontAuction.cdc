...
pub contract StoreFrontAuction {
    ...
    init() {
        ...
        self.collectionPublicPath = /public/StoreFrontAuctionCollection0xb7ff7d2e1d4e86a0
        self.collectionStoragePath = /storage/StoreFrontAuctionCollection0xb7ff7d2e1d4e86a0
    }
}
