...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xebd3f8c5c7a05a5a
    self.collectionStoragePath = /storage/StoreFrontCollection0xebd3f8c5c7a05a5a
    self.collectionPrivatePath = /private/StoreFrontCollection0xebd3f8c5c7a05a5a
