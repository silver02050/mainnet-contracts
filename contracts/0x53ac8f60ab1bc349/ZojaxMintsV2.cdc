...
pub contract ZojaxMintsV2: NonFungibleToken, ViewResolver {
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: ZojaxMintsV2.CollectionStoragePath,
                        publicPath: ZojaxMintsV2.CollectionPublicPath,
                        providerPath: /private/zojaxMintsV2Collection,
                        publicCollection: Type<&ZojaxMintsV2.Collection{ZojaxMintsV2.ZojaxMintsCollectionPublic}>(),
                        publicLinkedType: Type<&ZojaxMintsV2.Collection{ZojaxMintsV2.ZojaxMintsCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&ZojaxMintsV2.Collection{ZojaxMintsV2.ZojaxMintsCollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-ZojaxMintsV2.createEmptyCollection()
                        })
                    )
    ...
    pub resource interface ZojaxMintsCollectionPublic {
        ...
        pub fun borrowZojaxMints(id: UInt64): &ZojaxMintsV2.NFT? {
            post {
    ...
    init() {
        ...
        self.account.link<&ZojaxMintsV2.Collection{NonFungibleToken.CollectionPublic, ZojaxMintsV2.ZojaxMintsCollectionPublic, MetadataViews.ResolverCollection}>(
