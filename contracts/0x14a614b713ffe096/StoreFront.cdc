...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x14a614b713ffe096
    self.collectionStoragePath = /storage/StoreFrontCollection0x14a614b713ffe096
    self.collectionPrivatePath = /private/StoreFrontCollection0x14a614b713ffe096
