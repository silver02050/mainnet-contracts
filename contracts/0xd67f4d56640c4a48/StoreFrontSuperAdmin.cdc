...
pub contract StoreFrontSuperAdmin {
  ...
  init(requestedAdress: Address) {
    // Paths
    self.storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xd67f4d56640c4a48
    self.storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xd67f4d56640c4a48
