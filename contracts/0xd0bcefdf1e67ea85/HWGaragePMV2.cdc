...
pub event AdminMintToken(
    ...
    */
    pub resource Manager {
        ...
        */
        ...
        pub fun mintSequentialHWGarageCardV2(
            address: Address
            , packHash: String
            , packSeriesID: UInt64
        ...
        */
        ...
        pub fun mintSequentialHWGaragePackV2(
            address: Address
            , packHash: String
            , packSeriesID: UInt64
            , metadata: {String: String}
    ...
    */
    ...
    access(contract) fun mintSequentialAirdrop(seriesIDAirdrop: UInt64, metadata: {String: String}): @NonFungibleToken.NFT {
    ...
    */
    ...
    access(self) fun mintSequentialPack(
        ...
        let newPack <- HWGaragePackV2.mint(
