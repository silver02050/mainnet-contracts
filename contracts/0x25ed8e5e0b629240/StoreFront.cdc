...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x25ed8e5e0b629240
    self.collectionStoragePath = /storage/StoreFrontCollection0x25ed8e5e0b629240
    self.collectionPrivatePath = /private/StoreFrontCollection0x25ed8e5e0b629240
