...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xa46a2b7bfcf16d82
    self.collectionStoragePath = /storage/StoreFrontCollection0xa46a2b7bfcf16d82
    self.collectionPrivatePath = /private/StoreFrontCollection0xa46a2b7bfcf16d82
