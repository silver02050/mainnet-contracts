...
pub contract MusicPeaksMembershipToken: NonFungibleToken {
    ...
    pub resource NFT: NonFungibleToken.INFT, MetadataViews.Resolver {
            ...
            switch view {
                case Type<MetadataViews.Display>():
                    return MetadataViews.Display(
                        ...
                        thumbnail: MetadataViews.HTTPFile(url: "https://musicpeaks.mypinata.cloud/ipfs/".concat(self.eventImage))
                    )
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: MusicPeaksMembershipToken.FLOATCollectionStoragePath,
                        publicPath: MusicPeaksMembershipToken.FLOATCollectionPublicPath,
                        providerPath: /private/MusicPeaksMembershipTokenCollectionPrivatePath,
                        ...
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <- MusicPeaksMembershipToken.createEmptyCollection()
                        })
                    )
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    return MetadataViews.NFTCollectionDisplay(
                        name: "MusicPeaksMembershipToken",
                        description: "MusicPeaksMembershipToken is a proof of attendance platform on the Flow blockchain.",
                        externalURL: MetadataViews.ExternalURL("https://musicpeaks.com/membership/".concat(self.eventHost.toString()).concat("/").concat(self.eventId.toString())),
        ...
        init(_eventDescription: String, _eventHost: Address, _eventId: UInt64, _eventImage: String, _eventName: String, _originalRecipient: Address, _serial: UInt64) {
            ...
            self.eventsCap = getAccount(_eventHost)
                .getCapability<&FLOATEvents{FLOATEventsPublic, MetadataViews.ResolverCollection}>(MusicPeaksMembershipToken.FLOATEventsPublicPath)
        ...
        destroy() {
            ...
            // of who owns the MusicPeaksMembershipToken is going to be messed up. But that is their
            // fault. We shouldn't let that prevent the user from deleting the MusicPeaksMembershipToken.
    ...
    pub resource FLOATEvent: FLOATEventPublic, MetadataViews.Resolver {
        ...
        pub fun getCurrentHolder(serial: UInt64): TokenIdentifier? {
            ...
            let collection = getAccount(data.address).getCapability(MusicPeaksMembershipToken.FLOATCollectionPublicPath).borrow<&Collection{CollectionPublic}>()
    ...
    pub resource FLOATEvents: FLOATEventsPublic, MetadataViews.ResolverCollection {
        ...
        pub fun borrowSharedRef(fromHost: Address): &FLOATEvents {
            ...
            let otherFLOATEvents = getAccount(fromHost).getCapability(MusicPeaksMembershipToken.FLOATEventsPublicPath)
