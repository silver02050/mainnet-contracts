...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x6bef960e757d8adb
    self.collectionStoragePath = /storage/StoreFrontCollection0x6bef960e757d8adb
    self.collectionPrivatePath = /private/StoreFrontCollection0x6bef960e757d8adb
