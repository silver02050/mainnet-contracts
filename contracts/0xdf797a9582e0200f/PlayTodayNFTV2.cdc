...
pub contract PlayTodayNFTV2: NonFungibleToken {
    ...
    pub event Minted(id: UInt64, creator: Address, rarity: UInt8, uri: String, name: String, description: String, badgeUri: String)
            ...
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionData>():
                    return MetadataViews.NFTCollectionData(
                        storagePath: PlayTodayNFTV2.CollectionStoragePath,
                        publicPath: PlayTodayNFTV2.CollectionPublicPath,
                        providerPath: /private/playTodayNFTCollection,
                        publicCollection: Type<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic}>(),
                        publicLinkedType: Type<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Receiver,MetadataViews.ResolverCollection}>(),
                        providerLinkedType: Type<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic,NonFungibleToken.CollectionPublic,NonFungibleToken.Provider,MetadataViews.ResolverCollection}>(),
                        createEmptyCollectionFunction: (fun (): @NonFungibleToken.Collection {
                            return <-PlayTodayNFTV2.createEmptyCollection()
                        })
                    )
    ...
    pub resource interface PlayTodayNFTV2CollectionPublic {
        pub fun deposit(token: @NonFungibleToken.NFT)
        pub fun getIDs(): [UInt64]
        pub fun borrowNFT(id: UInt64): &NonFungibleToken.NFT
        pub fun borrowPlayTodayNFTV2(id: UInt64): &PlayTodayNFTV2.NFT? {
    ...
    //
    pub resource Collection: PlayTodayNFTV2CollectionPublic, NonFungibleToken.Provider, NonFungibleToken.Receiver, NonFungibleToken.CollectionPublic, MetadataViews.ResolverCollection {
    ...
    pub resource NFTMinter {
        ...
        pub fun mintNFT(
            ...
            recipient.deposit(token: <-create PlayTodayNFTV2.NFT(
                id: PlayTodayNFTV2.totalSupply, 
                creator: creator, 
                rarity: rarity,
                uri:uri,
                name: name,
    ...
    //
    pub fun fetch(_ from: Address, itemID: UInt64): &PlayTodayNFTV2.NFT? {
        let collection = getAccount(from)
            .getCapability(PlayTodayNFTV2.CollectionPublicPath)!
            .borrow<&PlayTodayNFTV2.Collection{PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic}>()
    ...
    init() {
        ...
        self.account.link<&PlayTodayNFTV2.Collection{NonFungibleToken.CollectionPublic, PlayTodayNFTV2.PlayTodayNFTV2CollectionPublic, MetadataViews.ResolverCollection}>(
