...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x507a949626c50f20
    self.collectionStoragePath = /storage/StoreFrontCollection0x507a949626c50f20
    self.collectionPrivatePath = /private/StoreFrontCollection0x507a949626c50f20
