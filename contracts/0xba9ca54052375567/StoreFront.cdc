...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xba9ca54052375567
    self.collectionStoragePath = /storage/StoreFrontCollection0xba9ca54052375567
    self.collectionPrivatePath = /private/StoreFrontCollection0xba9ca54052375567
