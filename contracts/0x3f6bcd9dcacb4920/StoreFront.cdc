...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x3f6bcd9dcacb4920
    self.collectionStoragePath = /storage/StoreFrontCollection0x3f6bcd9dcacb4920
    self.collectionPrivatePath = /private/StoreFrontCollection0x3f6bcd9dcacb4920
