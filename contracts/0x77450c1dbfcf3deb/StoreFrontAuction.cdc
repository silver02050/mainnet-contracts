...
pub contract StoreFrontAuction {
    ...
    init() {
        ...
        self.collectionPublicPath = /public/StoreFrontAuctionCollection0x77450c1dbfcf3deb
        self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x77450c1dbfcf3deb
    }
}
