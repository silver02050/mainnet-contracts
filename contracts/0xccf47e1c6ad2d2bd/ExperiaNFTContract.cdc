...
pub contract ExperiaNFTContract: NonFungibleToken {
    ...
    */
    ...
    pub resource NFTTemplate: NFTCollectionReceiver {
        ...
        init(name: String,  metadata: {String: AnyStruct}, thumbnail: String, description: String, amountToCreate: UInt64,
    ...
    init() {
        ...
        self.CollectionPublicPath = /public/ExperiaCollectionPublic

        self.CollectionStoragePath = /storage/ExperiaViewNFTCollection
