...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0xd0df0c6c2a7e64d4
    self.collectionStoragePath = /storage/StoreFrontCollection0xd0df0c6c2a7e64d4
    self.collectionPrivatePath = /private/StoreFrontCollection0xd0df0c6c2a7e64d4
