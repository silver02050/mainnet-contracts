...
pub contract Stanz: NonFungibleToken {
        ...
        pub fun resolveView(_ view: Type): AnyStruct? {
            switch view {
                ...
                case Type<MetadataViews.NFTCollectionDisplay>():
                    ...
                    if var _file = self.metadata["SquareImageFile"] { squareImageFile = _file }
                    if var _type = self.metadata["SquareImageType"] { squareImageType = _type }
                    ...
                    if var _file = self.metadata["BannerImageFile"] { bannerImageFile = _file }
                    if var _type = self.metadata["BannerImageType"] { bannerImageType = _type }
	...
	init() {
        ...
        self.account.link<&{NonFungibleToken.CollectionPublic, Stanz.StanzCollectionPublic, MetadataViews.ResolverCollection}>(
