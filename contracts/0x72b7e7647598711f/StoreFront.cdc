...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x72b7e7647598711f
    self.collectionStoragePath = /storage/StoreFrontCollection0x72b7e7647598711f
    self.collectionPrivatePath = /private/StoreFrontCollection0x72b7e7647598711f
