...
pub contract StoreFront: NonFungibleToken {
  ...
  init() {
    // Paths
    self.collectionPublicPath = /public/StoreFrontCollection0x222c3b2919b1c91c
    self.collectionStoragePath = /storage/StoreFrontCollection0x222c3b2919b1c91c
    self.collectionPrivatePath = /private/StoreFrontCollection0x222c3b2919b1c91c
