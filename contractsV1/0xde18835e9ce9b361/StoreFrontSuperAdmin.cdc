...
contract StoreFrontSuperAdmin{ 
	...
	init(requestedAdress: Address){ 
		// Paths
		self.storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xde18835e9ce9b361
		self.storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xde18835e9ce9b361
