...
contract StoreFrontSuperAdmin{ 
	...
	init(requestedAdress: Address){ 
		// Paths
		self.storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x0d6cd6ae41e1192c
		self.storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x0d6cd6ae41e1192c
