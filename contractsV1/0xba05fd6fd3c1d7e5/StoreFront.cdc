...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xba05fd6fd3c1d7e5
		self.collectionStoragePath = /storage/StoreFrontCollection0xba05fd6fd3c1d7e5
		self.collectionPrivatePath = /private/StoreFrontCollection0xba05fd6fd3c1d7e5
