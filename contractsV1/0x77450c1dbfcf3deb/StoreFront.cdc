...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x77450c1dbfcf3deb
		self.collectionStoragePath = /storage/StoreFrontCollection0x77450c1dbfcf3deb
		self.collectionPrivatePath = /private/StoreFrontCollection0x77450c1dbfcf3deb
