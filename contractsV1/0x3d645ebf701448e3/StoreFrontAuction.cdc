...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x3d645ebf701448e3
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x3d645ebf701448e3
	}
}
