...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x3d645ebf701448e3
		self.collectionStoragePath = /storage/StoreFrontCollection0x3d645ebf701448e3
		self.collectionPrivatePath = /private/StoreFrontCollection0x3d645ebf701448e3
