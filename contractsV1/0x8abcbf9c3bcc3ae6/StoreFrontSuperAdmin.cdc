...
contract StoreFrontSuperAdmin{ 
	...
	init(requestedAdress: Address){ 
		// Paths
		self.storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0x8abcbf9c3bcc3ae6
		self.storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0x8abcbf9c3bcc3ae6
