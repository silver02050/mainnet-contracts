...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x6670649f173088c8
		self.collectionStoragePath = /storage/StoreFrontCollection0x6670649f173088c8
		self.collectionPrivatePath = /private/StoreFrontCollection0x6670649f173088c8
