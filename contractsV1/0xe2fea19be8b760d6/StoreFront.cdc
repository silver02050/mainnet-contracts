...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xe2fea19be8b760d6
		self.collectionStoragePath = /storage/StoreFrontCollection0xe2fea19be8b760d6
		self.collectionPrivatePath = /private/StoreFrontCollection0xe2fea19be8b760d6
