...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xf75a5a4ff94c16ca
		self.collectionStoragePath = /storage/StoreFrontCollection0xf75a5a4ff94c16ca
		self.collectionPrivatePath = /private/StoreFrontCollection0xf75a5a4ff94c16ca
