...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x80137c29862fcc3c
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x80137c29862fcc3c
	}
}
