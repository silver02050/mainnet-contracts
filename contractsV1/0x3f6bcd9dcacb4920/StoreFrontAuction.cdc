...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x3f6bcd9dcacb4920
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x3f6bcd9dcacb4920
	}
}
