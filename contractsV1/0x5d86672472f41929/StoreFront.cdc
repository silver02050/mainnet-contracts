...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x5d86672472f41929
		self.collectionStoragePath = /storage/StoreFrontCollection0x5d86672472f41929
		self.collectionPrivatePath = /private/StoreFrontCollection0x5d86672472f41929
