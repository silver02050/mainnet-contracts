...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xb681e84ceea6299e
		self.collectionStoragePath = /storage/StoreFrontCollection0xb681e84ceea6299e
		self.collectionPrivatePath = /private/StoreFrontCollection0xb681e84ceea6299e
