...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x93b0e9a5bc0343af
		self.collectionStoragePath = /storage/StoreFrontCollection0x93b0e9a5bc0343af
		self.collectionPrivatePath = /private/StoreFrontCollection0x93b0e9a5bc0343af
