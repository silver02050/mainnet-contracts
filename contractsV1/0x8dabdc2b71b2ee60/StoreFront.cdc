...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x8dabdc2b71b2ee60
		self.collectionStoragePath = /storage/StoreFrontCollection0x8dabdc2b71b2ee60
		self.collectionPrivatePath = /private/StoreFrontCollection0x8dabdc2b71b2ee60
