...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x8bfee6d347f1d22e
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x8bfee6d347f1d22e
	}
}
