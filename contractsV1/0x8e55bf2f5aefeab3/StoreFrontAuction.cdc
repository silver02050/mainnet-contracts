...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x8e55bf2f5aefeab3
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x8e55bf2f5aefeab3
	}
}
