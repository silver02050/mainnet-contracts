...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x2541a589a67f6eb0
		self.collectionStoragePath = /storage/StoreFrontCollection0x2541a589a67f6eb0
		self.collectionPrivatePath = /private/StoreFrontCollection0x2541a589a67f6eb0
