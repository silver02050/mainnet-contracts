...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x026fad499cb84918
		self.collectionStoragePath = /storage/StoreFrontCollection0x026fad499cb84918
		self.collectionPrivatePath = /private/StoreFrontCollection0x026fad499cb84918
