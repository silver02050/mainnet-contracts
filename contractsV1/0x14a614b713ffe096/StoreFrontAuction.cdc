...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x14a614b713ffe096
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x14a614b713ffe096
	}
}
