...
access(all)
contract ZojaxMintsV3: NonFungibleToken, ViewResolver{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionData>():
					return MetadataViews.NFTCollectionData(storagePath: ZojaxMintsV3.CollectionStoragePath, publicPath: ZojaxMintsV3.CollectionPublicPath, publicCollection: Type<&ZojaxMintsV3.Collection>(), publicLinkedType: Type<&ZojaxMintsV3.Collection>(), createEmptyCollectionFunction: fun (): @{NonFungibleToken.Collection}{ 
							return <-ZojaxMintsV3.createEmptyCollection(nftType: Type<@ZojaxMintsV3.Collection>())
						})
				case Type<MetadataViews.NFTCollectionDisplay>():
					...
					return MetadataViews.NFTCollectionDisplay(name: "Labrador Retriever", description: "Labrador Retriever", externalURL: MetadataViews.ExternalURL("https://flow.mydogsnft.com"), squareImage: media, bannerImage: media, socials:{ "twitter": MetadataViews.ExternalURL("https://twitter.com/flow_blockchain")})
	...
	resource interface ZojaxMintsCollectionPublic{ 
		...
		fun borrowZojaxMints(id: UInt64): &ZojaxMintsV3.NFT?{ 
			post{ 
	...
	resource NFTMinter{ 
		...
		fun mintNFT(recipient: &{NonFungibleToken.CollectionPublic}, name: String, description: String, thumbnail: String, royalties: [MetadataViews.Royalty]){ 
			...
			metadata["foo"] = "bar"
			// create a new NFT
			var newNFT <- create NFT(id: ZojaxMintsV3.totalSupply, name: name, description: description, thumbnail: thumbnail, royalties: royalties, metadata: metadata)
	...
	init(){ 
		...
		var capability_1 = self.account.capabilities.storage.issue<&ZojaxMintsV3.Collection>(self.CollectionStoragePath)
