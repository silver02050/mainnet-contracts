...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0xd953a7bdc5e2f7f0
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0xd953a7bdc5e2f7f0
	}
}
