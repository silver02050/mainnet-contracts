...
contract StoreFront: NonFungibleToken{ 
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			...
			switch view{ 
				case Type<MetadataViews.Display>():
					return MetadataViews.Display(name: metadata["name"]!, description: metadata["description"]!, thumbnail: MetadataViews.HTTPFile(url: metadata["image"]!))
				case Type<StoreFrontViews.StoreFrontDisplay>():
					return StoreFrontViews.StoreFrontDisplay(name: metadata["name"]!, description: metadata["description"]!, thumbnail: MetadataViews.HTTPFile(url: metadata["image"]!), metadata: metadata)
			}
			return nil
		}
	...
	init(){ 
		...
		self.collectionPrivatePath = /private/StoreFrontCollection
