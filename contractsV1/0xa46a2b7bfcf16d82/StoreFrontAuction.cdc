...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0xa46a2b7bfcf16d82
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0xa46a2b7bfcf16d82
	}
}
