...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x7920808941f61c27
		self.collectionStoragePath = /storage/StoreFrontCollection0x7920808941f61c27
		self.collectionPrivatePath = /private/StoreFrontCollection0x7920808941f61c27
