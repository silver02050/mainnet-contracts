...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xce6f51fdfcb8f2a6
		self.collectionStoragePath = /storage/StoreFrontCollection0xce6f51fdfcb8f2a6
		self.collectionPrivatePath = /private/StoreFrontCollection0xce6f51fdfcb8f2a6
