...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0xce6f51fdfcb8f2a6
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0xce6f51fdfcb8f2a6
	}
}
