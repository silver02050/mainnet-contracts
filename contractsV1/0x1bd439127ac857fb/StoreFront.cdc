...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x1bd439127ac857fb
		self.collectionStoragePath = /storage/StoreFrontCollection0x1bd439127ac857fb
		self.collectionPrivatePath = /private/StoreFrontCollection0x1bd439127ac857fb
