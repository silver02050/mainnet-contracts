...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xbc2692147555df30
		self.collectionStoragePath = /storage/StoreFrontCollection0xbc2692147555df30
		self.collectionPrivatePath = /private/StoreFrontCollection0xbc2692147555df30
