...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0xf8f8e5db161c815d
		self.collectionStoragePath = /storage/StoreFrontCollection0xf8f8e5db161c815d
		self.collectionPrivatePath = /private/StoreFrontCollection0xf8f8e5db161c815d
