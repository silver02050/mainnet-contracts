...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x9aac0b904ec7527a
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x9aac0b904ec7527a
	}
}
