...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x9aac0b904ec7527a
		self.collectionStoragePath = /storage/StoreFrontCollection0x9aac0b904ec7527a
		self.collectionPrivatePath = /private/StoreFrontCollection0x9aac0b904ec7527a
