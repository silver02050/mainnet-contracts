...
contract StoreFront: NonFungibleToken{ 
	...
	init(){ 
		// Paths
		self.collectionPublicPath = /public/StoreFrontCollection0x26f1e1ba5831e15b
		self.collectionStoragePath = /storage/StoreFrontCollection0x26f1e1ba5831e15b
		self.collectionPrivatePath = /private/StoreFrontCollection0x26f1e1ba5831e15b
