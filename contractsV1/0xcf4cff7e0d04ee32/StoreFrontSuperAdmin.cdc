...
contract StoreFrontSuperAdmin{ 
	...
	init(){ 
		// Paths
		self.storeFrontAdminReceiverPublicPath = /public/AdminTokenReceiver0xcf4cff7e0d04ee32
		self.storeFrontAdminReceiverStoragePath = /storage/AdminTokenReceiver0xcf4cff7e0d04ee32
