...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x6bef960e757d8adb
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x6bef960e757d8adb
	}
}
