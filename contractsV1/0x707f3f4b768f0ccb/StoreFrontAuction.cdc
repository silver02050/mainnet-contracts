...
contract StoreFrontAuction{ 
	...
	init(){ 
		...
		self.collectionPublicPath = /public/StoreFrontAuctionCollection0x707f3f4b768f0ccb
		self.collectionStoragePath = /storage/StoreFrontAuctionCollection0x707f3f4b768f0ccb
	}
}
